<template>
	<!-- Thanks to sanya_misharin for the code used to create this component!
		https://vuejsexamples.com/simple-calendar-on-vuejs-and-bootstrap-4/ -->

	<b-container>
		<div class="b-calendar">
			<b-row>
				<b-col v-if="showSelectedDay" cols="4">
...
export default {
	props: {
		// Set props to modify component here
		showSelectedDay: {
			type: Boolean,
			default: true
		},
